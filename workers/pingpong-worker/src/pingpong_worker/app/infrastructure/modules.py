...
class InfrastructureModule(Module):
    ...
    def configure(self, binder: Binder):
        # Cache
        from pingpong_worker.app.domain.caches.pp_cache import PPCache
        from pingpong_worker.app.infrastructure.caches.pp_redis_cache import PPRedisCache
        ...
        from pingpong_worker.app.infrastructure.persistence.repositories.sql_ping_repository import (
            SQLPingRepository,
        )
        ...
        from pingpong_worker.app.infrastructure.persistence.repositories.sql_pong_repository import (
            SQLPongRepository,
        )
